...
import { buildCardNarrativePrompt, buildLifeReportPrompt, buildResultNarrativePrompt } from './buildNarrativePrompts.ts';
import { parseEventCardNarrative, parseLifeReport, parseOpportunityResultNarrative } from './validateNarrativeOutput.ts';
